(ns minions.adapters.bored-activity
  (:require [minions.models.bored-activity :as m.bored-activity]
            [minions.wire.in.bored-activity :as in.bored-activity]
            [minions.wire.out.bored-activity :as out.bored-activity]
            [schema.core :as s]))
