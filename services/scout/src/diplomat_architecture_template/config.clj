(ns diplomat-architecture-template.config
  (:require [clojure.edn :as edn]
            [clojure.java.io :as io]
            [datomic.api :as d]
            [diplomat-architecture-template.db.datomic.bored-activity :as db]
            [diplomat-architecture-template.diplomat.consumer :as consumer]
            [org.httpkit.client]
...
(def application-name "template")

(def db-uri (str "datomic:free://localhost:4334/" application-name "?password=" (System/getenv "DATOMIC_PASSWORD")))
