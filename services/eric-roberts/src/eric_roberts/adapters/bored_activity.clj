(ns eric-roberts.adapters.bored-activity
  (:require [eric-roberts.models.bored-activity :as m.bored-activity]
            [eric-roberts.wire.in.bored-activity :as in.bored-activity]
            [eric-roberts.wire.out.bored-activity :as out.bored-activity]
            [schema.core :as s]))
