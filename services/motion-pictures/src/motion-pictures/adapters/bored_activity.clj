(ns motion-pictures.adapters.bored-activity
  (:require [motion-pictures.models.bored-activity :as m.bored-activity]
            [motion-pictures.wire.in.bored-activity :as in.bored-activity]
            [motion-pictures.wire.out.bored-activity :as out.bored-activity]
            [schema.core :as s]))
