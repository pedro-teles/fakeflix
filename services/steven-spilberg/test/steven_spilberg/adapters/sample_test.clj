(ns steven-spilberg.adapters.sample-test
  (:require [clojure.test :refer [deftest is testing]]
            [steven-spilberg.adapters.bored-activity :as a.bored-activity]
            [steven-spilberg.fixtures.sample-fixtures :as fixtures]))
