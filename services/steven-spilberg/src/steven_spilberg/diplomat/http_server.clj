(ns steven-spilberg.diplomat.http-server
  (:require [steven-spilberg.adapters.bored-activity :as a.bored-activity]
            [steven-spilberg.config.project :as config.project]
            [steven-spilberg.controllers.bored-activity :as c.bored-activity]
            [steven-spilberg.diplomat.producer :as producer]
            [steven-spilberg.interceptors :refer [handle]]
